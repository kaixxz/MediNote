        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <h1 className="text-xl font-bold text-white">Noto</h1>
            </div>
      ...
      <section className="min-h-screen flex items-center justify-center px-6 lg:px-8 pt-20">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="text-center lg:text-left space-y-8 animate-slide-in-left">
            <div className="inline-flex items-center space-x-2 bg-gray-900/50 border border-gray-700 rounded-full px-4 py-2 text-sm text-gray-300 animate-float">
          ...
          <div className="relative animate-slide-in-right">
            <div className="bg-gray-900/50 backdrop-blur-sm border border-gray-700 rounded-2xl p-6 shadow-2xl animate-glow">
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="text-sm text-gray-400 ml-4">Live Demo</span>
              </div>
      ...
      <section className="py-20 px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="bg-gray-900/50 border border-gray-700 rounded-2xl text-center hover:bg-gray-800/50 transition-all duration-300 transform hover:scale-105">
